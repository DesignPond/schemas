...
use  Schema\Service\Mailer\MailerInterface;
...
class ComposeController extends BaseController {
    ...
    public function __construct( ProjetInterface $projet, CategorieInterface $categorie, ThemeInterface $theme, SubthemeInterface $subtheme, MailerInterface $mailer ){
    ...
    public function update()
    {
        ...
        $value = ($column == 'commentaire' ? nl2br($value) : $value);
    ...
    public function status()
    {
        ...
        $send = false; // do we have to send an email with that?
        ...
        if($send)
        {
	        $this->mailer->sendemail($id,$status);
        }
